...
func newApiHandler() *gotest.Handler {
	...
	d.IDao = dao.NewApiDao(d.DB, c.ICache.(cache.ApiCache))

	// init mock handler
	h := gotest.NewHandler(d, testData)
	h.IHandler = &apiHandler{iDao: d.IDao.(dao.ApiDao)}
	iHandler := h.IHandler.(ApiHandler)
...
func Test_apiHandler_Create(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := &types.CreateApiRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.Api))
...
func Test_apiHandler_DeleteByID(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
...
func Test_apiHandler_DeleteByIDs(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteApisByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = gohttp.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteApisByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_apiHandler_UpdateByID(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := &types.UpdateApiByIDRequest{}
	_ = copier.Copy(testData, h.TestData.(*model.Api))
...
func Test_apiHandler_GetByID(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
...
func Test_apiHandler_GetByCondition(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("GetByCondition"), &types.GetApiByConditionRequest{
		query.Conditions{
...
func Test_apiHandler_ListByIDs(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("ListByIDs"), &types.ListApisByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = gohttp.Post(result, h.GetRequestURL("ListByIDs"), &types.ListApisByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}

func Test_apiHandler_ListByLastID(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
...
func Test_apiHandler_List(t *testing.T) {
	h := newApiHandler()
	defer h.Close()
	testData := h.TestData.(*model.Api)
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("List"), &types.ListApisRequest{query.Params{
		Page: 0,
		Size: 10,
